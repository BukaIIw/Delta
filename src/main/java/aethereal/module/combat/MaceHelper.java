    ...
    public void a(TickEvent event) {
        ...
        if ((this.d <= 198 && aM_.player.isOnGround()) || aM_.player.isTouchingWater() || aM_.player.age < 5) {
            if (this.e && tasks.isEmpty()) {
                if (this.f[1] > 8) {
                    HydrogenClient.h().d().v().a().a(this.f[0], this.f[1], 1);
                } else {
        ...
        if (!ServerUtil.a.a() || ServerUtil.e()) {
            ...
            if (entry == null || ((platform.inject.accessors.ItemCooldownEntryAccessor) entry).getEndTick() - cooldowns.getTick() <= 10) {
                ...
                TriggerBot triggerBot = HydrogenClient.h().d().t().X();
                boolean fromAura = aura.s() != null;
                LivingEntity target = fromAura ? aura.s() : triggerBot.s();
                if (target == null || target.isBlocking() || aM_.player.isOnGround() || MaceUtil.a() || this.e || aM_.player.fallDistance <= 0.0f || !tasks.isEmpty() || !HydrogenClient.h().d().v().a().a().isEmpty() || Math.hypot(target.getPos().x - aM_.player.getPos().x, target.getPos().z - aM_.player.getPos().z) > 6.0d) {
                    return;
                }
                ...
                this.f = iArr;
                if (hotbar == -1) {
                    HydrogenClient.h().d().v().a().a(slotMace, aM_.player.getInventory().selectedSlot, 1);
                } else {
