...
import hydrogen.lib.javassist.FrameSupport;
...
public class UnixConnection implements hydrogen.lib.jsoup.Connection {

    @Generated
    private static final Logger a = LogManager.b((Class<?>) UnixConnection.class);
    ...
    public UnixConnection(String path) throws IOException {
        this.c.connect(UnixDomainSocketAddress.of(Path.of(path, new String[0])));
