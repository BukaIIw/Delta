...
import hydrogen.network.AccountProcessor;
import hydrogen.autobuy.AutoBuyProcessor;
import hydrogen.autobuy.BatchProcessor;
import hydrogen.autobuy.CollectorProcessor;
import hydrogen.command.CommandProcessor;
import hydrogen.cosmetic.CosmeticsProcessor;
import hydrogen.discord.DiscordProcessor;
import hydrogen.ui.element.DragProcessor;
import hydrogen.render.Draw2DProcessor;
import hydrogen.render.Draw3DProcessor;
import hydrogen.friend.FriendProcessor;
import hydrogen.handler.HandlerProcessor;
import hydrogen.lib.log4j.Logger_2;
import hydrogen.macro.MacrosProcessor;
import hydrogen.config.ModuleProcessor;
import hydrogen.notification.NotificationProcessor;
import hydrogen.config.ResourcePacksProcessor;
import hydrogen.handler.RotationProcessor;
import hydrogen.staff.StaffProcessor;
