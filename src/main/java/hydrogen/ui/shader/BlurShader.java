...
import hydrogen.event.ResizeEvent;
import hydrogen.ui.shader.Shader;
...
public class BlurShader extends Shader implements Interface {
    ...
    public BlurShader() {
        super(Identifier.of("hydrogen", "core/rect/blurred_rect"), VertexFormats.POSITION_TEXTURE_COLOR);
        this.n = new ArrayList();
        this.o = new ShaderProgramKey(Identifier.of("hydrogen", "core/blur/upscale"), VertexFormats.POSITION, Defines.EMPTY);
        this.p = new ShaderProgramKey(Identifier.of("hydrogen", "core/blur/downscale"), VertexFormats.POSITION, Defines.EMPTY);
        EventManager.a(this);
    }
    ...
    public void a(MatrixStack matrixStack) {
        if (!this.n.isEmpty()) {
            ...
            try {
                a(matrixStack, this.p, aM_.getFramebuffer(), (Framebuffer) this.n.getFirst(), 0, 24);
                for (int i = 0; i < actualPasses; i++) {
                    a(matrixStack, this.p, (Framebuffer) this.n.get(i), (Framebuffer) this.n.get(i + 1), i + 1, 24);
                }
                for (int i2 = actualPasses; i2 > 0; i2--) {
                    a(matrixStack, this.o, (Framebuffer) this.n.get(i2), (Framebuffer) this.n.get(i2 - 1), i2, 24);
                }
            } finally {
